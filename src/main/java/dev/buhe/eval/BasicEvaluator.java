...
public class BasicEvaluator {
    ...
    public static class ASTListEx extends ASTList {
        ...
        public Object eval(Environment environment) {
            throw new LinedExpetion("cannot eval: " + toString(), this);
        }
    }
    ...
    public static class NameEx extends Name {
        ...
        public Object eval(Environment environment) {
            ...
            if (value == null) {
                throw new LinedExpetion("undefined name: " + name(), this);
            } else {
                return value;
            }
        }
    ...
    public static class NegativeEx extends NegativeExpr {
        ...
        public Object eval(Environment environment) {
            ...
            if (value instanceof Integer) {
                ...
                throw new LinedExpetion("bad type for -", this);
            }
        }
    }
    ...
    public static class BinaryEx extends BinaryExpr {
        ...
        protected Object computeAssign(Environment environment, Object rvalue) {
            ...
            if (l instanceof Name) {
                ...
                throw new LinedExpetion("bad assignment", this);
            }
        }
        ...
        protected Object computeOp(Object left, String op, Object right) {
            if (left instanceof Integer && right instanceof Integer) {
                ...
                if (op.equals("+")) {
                    ...
                    throw new LinedExpetion("bad type", this);
                }
            }
        }
        ...
        protected Object computeNumber(Integer left, String op, Integer right) {
            ...
            if (op.equals("+")) {
                ...
                throw new LinedExpetion("bad operator", this);
            }
        }
    }
